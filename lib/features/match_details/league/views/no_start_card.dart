        ...
        if (matchDetails.status == 'notstarted')
          Center(
            child: Align(
              ...
              child: Text('Match has not started yet',style: TextStyle(color: kPastColor,fontSize: 4.w),),
            ),
          )
        else if (matchDetails.status == 'canceled')
          Center(
            child: Center(
              child: Text("Match is canceled",style: TextStyle(color: kPastColor,fontSize: 4.w),),
            ),
          )
        else if (matchDetails.status == 'postponed')
            Center(
              child: Center(
                child: Text("Match is postponed",style: TextStyle(color: kPastColor,fontSize: 4.w),),
              ),
            )
      ],
    );
